...
class Operator(bpy.types.Operator):
    ...
    def register(cls):
        ...
        bpy.types.Scene.quality_selection_mode = \
...
class Atom():
    ...
    def drawObj(self,ftoc):
        ...
        bpy.ops.mesh.primitive_uv_sphere_add(segments=qualitydic[draw_quality],ring_count=qualitydic[draw_quality]/2,size=sizedic[self.sym],location=toCarth(ftoc,[self.xpos,self.ypos,self.zpos]))
